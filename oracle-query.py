...
For some reason the following chunks of code never run.
raise JiraUpdateError("Task update process failed") on line 92
and on lines 101-103. help with complete coverage here.
    except Exception as e:
        logger.error(f"Unexpected error in Jira update process: {str(e)}")
        raise
